...
import ru.pms.restdocsexample.web.model.BeerStyleEnum;
...
@ComponentScan(basePackages = "ru.pms.restdocsexample.web.mappers")
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString()).accept(MediaType.APPLICATION_JSON))
                ...
                .andDo(document("v1/beer-get",
                        pathParameters(parameterWithName("beerId").description("UUID for desired beer to get.")),
                        responseFields(
